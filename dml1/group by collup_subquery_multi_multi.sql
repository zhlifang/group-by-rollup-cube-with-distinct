...
select inttype, doubletype, floattype from (select * from orctbl where id>10) where inttype = inttype1 and doubletype = doubletype1 and floattype = floattype1 group by rollup (inttype, doubletype, floattype) order by inttype, doubletype, floattype;

select distinct inttype, doubletype, floattype from (select * from orctbl where id>10) where inttype = inttype1 and doubletype = doubletype1 and floattype = floattype1 group by rollup (inttype, doubletype, floattype) order by inttype, doubletype, floattype;
...
select inttype, doubletype, floattype from (select * from orctbl where id>10) where id>15 group by rollup (inttype, doubletype, floattype) order by inttype, doubletype, floattype;

select distinct inttype, doubletype, floattype from (select * from orctbl where id>10) where id>15 group by rollup (inttype, doubletype, floattype) order by inttype, doubletype, floattype;
...
select inttype, doubletype, floattype from (select * from orctbl where id>10) group by rollup (inttype, doubletype, floattype) order by inttype, doubletype, floattype;

select distinct inttype, doubletype, floattype from (select * from orctbl where id>10) group by rollup (inttype, doubletype, floattype) order by inttype, doubletype, floattype;
...
select decimaltype, stringtype, varchar32type from (select * from orctbl where id>10) where decimaltype = decimaltype1 and stringtype = stringtype1 and varchar32type = varchar32type1 group by rollup (decimaltype, stringtype, varchar32type) order by decimaltype, stringtype, varchar32type;

select distinct decimaltype, stringtype, varchar32type from (select * from orctbl where id>10) where decimaltype = decimaltype1 and stringtype = stringtype1 and varchar32type = varchar32type1 group by rollup (decimaltype, stringtype, varchar32type) order by decimaltype, stringtype, varchar32type;
...
select decimaltype, stringtype, varchar32type from (select * from orctbl where id>10) where id>15 group by rollup (decimaltype, stringtype, varchar32type) order by decimaltype, stringtype, varchar32type;

select distinct decimaltype, stringtype, varchar32type from (select * from orctbl where id>10) where id>15 group by rollup (decimaltype, stringtype, varchar32type) order by decimaltype, stringtype, varchar32type;
...
select decimaltype, stringtype, varchar32type from (select * from orctbl where id>10) group by rollup (decimaltype, stringtype, varchar32type) order by decimaltype, stringtype, varchar32type;

select distinct decimaltype, stringtype, varchar32type from (select * from orctbl where id>10) group by rollup (decimaltype, stringtype, varchar32type) order by decimaltype, stringtype, varchar32type;
...
select longtype, bytetype, shorttype from (select * from orctbl where id>10) where longtype = longtype1 and bytetype = bytetype1 and shorttype = shorttype1 group by rollup (longtype, bytetype, shorttype) order by longtype, bytetype, shorttype;

select distinct longtype, bytetype, shorttype from (select * from orctbl where id>10) where longtype = longtype1 and bytetype = bytetype1 and shorttype = shorttype1 group by rollup (longtype, bytetype, shorttype) order by longtype, bytetype, shorttype;
...
select longtype, bytetype, shorttype from (select * from orctbl where id>10) where id>15 group by rollup (longtype, bytetype, shorttype) order by longtype, bytetype, shorttype;

select distinct longtype, bytetype, shorttype from (select * from orctbl where id>10) where id>15 group by rollup (longtype, bytetype, shorttype) order by longtype, bytetype, shorttype;
...
select longtype, bytetype, shorttype from (select * from orctbl where id>10) group by rollup (longtype, bytetype, shorttype) order by longtype, bytetype, shorttype;

select distinct longtype, bytetype, shorttype from (select * from orctbl where id>10) group by rollup (longtype, bytetype, shorttype) order by longtype, bytetype, shorttype;
...
select booleantype, datetype, timestamptype from (select * from orctbl where id>10) where booleantype = booleantype1 and datetype = datetype1 and timestamptype = timestamptype1 group by rollup (booleantype, datetype, timestamptype) order by booleantype, datetype, timestamptype;

select distinct booleantype, datetype, timestamptype from (select * from orctbl where id>10) where booleantype = booleantype1 and datetype = datetype1 and timestamptype = timestamptype1 group by rollup (booleantype, datetype, timestamptype) order by booleantype, datetype, timestamptype;
...
select booleantype, datetype, timestamptype from (select * from orctbl where id>10) where id>15 group by rollup (booleantype, datetype, timestamptype) order by booleantype, datetype, timestamptype;

select distinct booleantype, datetype, timestamptype from (select * from orctbl where id>10) where id>15 group by rollup (booleantype, datetype, timestamptype) order by booleantype, datetype, timestamptype;
...
select booleantype, datetype, timestamptype from (select * from orctbl where id>10) group by rollup (booleantype, datetype, timestamptype) order by booleantype, datetype, timestamptype;

select distinct booleantype, datetype, timestamptype from (select * from orctbl where id>10) group by rollup (booleantype, datetype, timestamptype) order by booleantype, datetype, timestamptype;
